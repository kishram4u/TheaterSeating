...
import com.org.command.TheaterSection;
...
public class TheaterSeatingServiceImpl implements TheaterSeatingService {
        ...
        for(int i=0 ; i<rows.length ; i++){
            ...
            for(int j=0 ; j<sections.length ; j++){
                ...
                try{
                    ...
                    throw new NumberFormatException("'" + sections[j] + "'" + " is invalid section capacity. Please re_correct it.");
    ...
    public List<TheaterRequest> getTicketRequests(String ticketRequests) throws NumberFormatException{
        ...
        for(String r : requests){
            ...
            try{
                ...
                throw new NumberFormatException("'" + rData[1] + "'" + " is invalid ticket request. Please re_correct it.");
            }
    ...
    /*
     * To avoid waste of seats,find complementing request.
     * 
    ...
    public void processTicketRequests(TheaterLayout layout, List<TheaterRequest> requests) {
        ...
        System.out.println("Seats Distributed.\n");
